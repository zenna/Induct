...
\subsection*{query}
To support conditional inference Church generalises evaluation to \textit{conditional simulation} \cite{VIKASH}
...
One important detail is the layer of abstraction afforded with the use of \verb+state-queries+.
