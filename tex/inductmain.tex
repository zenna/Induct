...
Sparse sampling is a method for choosing actions to maximize rewards in MDPs for which the learning agent has a generative model of the world. A \emph{generative model} is a probability distribution $p: S\times A 
