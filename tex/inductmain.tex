...
\subsection*{Church}
Church \citep{church} is an extension of the programming language Scheme to allow stochastic functions.
...
Listing \ref{fig:poissonRnd} demonstrates the implementation of an Elementary Random Primitive of a discrete Poisson distribution and is equivalent to the \verb+(poisson lambda)+ function found in Church.
...
vvar sIf = function(noiseLevel, predicate, consequent, alternate) {
