...
Sparse sampling techniques sample from this model to grow a state-action-reward tree to a specified depth, then transform this tree into an approximate MDP and use normal methods to solve it. 
...
Recent work has focused on probabilistic program induction using Church.
